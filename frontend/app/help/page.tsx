      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
          ...
          >
            ...
            <h3 className="font-bold text-text-primary group-hover:text-primary transition-colors">Browse Projects</h3>
            <p className="text-sm text-text-muted mt-1">Explore our catalog of real-world projects</p>
          </Link>
          ...
          >
            ...
            <h3 className="font-bold text-text-primary group-hover:text-primary transition-colors">My Workspace</h3>
            <p className="text-sm text-text-muted mt-1">Track and manage your active projects</p>
          </Link>
          ...
          >
            ...
            <h3 className="font-bold text-text-primary group-hover:text-primary transition-colors">My Profile</h3>
            <p className="text-sm text-text-muted mt-1">Manage your account and settings</p>
          </Link>
        </div>
        ...
        <div>
          ...
          <div className="space-y-4">
            {faqs.map((faq, idx) => (
              ...
              >
                <summary className="font-bold text-text-primary flex items-center justify-between list-none">
                  {faq.q}
                ...
                <p className="text-text-secondary mt-3 leading-relaxed">{faq.a}</p>
              </details>
            ))}
          </div>
        </div>

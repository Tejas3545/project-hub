        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="space-y-4">
                {filteredProjects.map((project) => (
                    <div key={project.id} className="glass-card p-6 hover:glow transition-all">
                        <div className="flex items-start justify-between gap-4">
                            <div className="flex-1">
                                <div className="flex items-center gap-3 mb-2">
                                    ...
                                    <span className={`px-2 py-1 rounded text-xs font-medium ${project.difficulty === 'EASY' ? 'bg-green-500/20 text-green-400' :
                            ...
                            <div className="flex gap-2">
                                <Link
                                    ...
                                    className="px-4 py-2 bg-dark-card border border-dark-lighter rounded-lg text-text-secondary hover:text-primary hover:border-primary/50 transition-colors text-sm font-medium"
                                >
                                    Edit
                                </Link>
                                <button
            ...
            {filteredProjects.length === 0 && (
                <div className="glass-card p-12 text-center">
                    <p className="text-text-secondary mb-4">No {filter !== 'all' && filter + ' '}projects found</p>
                    <Link
                        href="/admin/projects/new"

                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 bg-dark-card border border-dark-lighter rounded-lg text-text-primary placeholder-text-muted focus:outline-none focus:ring-2 focus:ring-primary"
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    className="w-full px-4 py-3 bg-dark-card border border-dark-lighter rounded-lg text-text-primary placeholder-text-muted focus:outline-none focus:ring-2 focus:ring-primary resize-none"
                                    placeholder="Describe the real-world industry context and why this project matters..."
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    onChange={handleChange}
                                    className="w-full px-4 py-3 bg-dark-card border border-dark-lighter rounded-lg text-text-primary placeholder-text-muted focus:outline-none focus:ring-2 focus:ring-primary resize-none"
                                    placeholder="Define what will be built, key features, technical requirements..."
                                />
                            </div>

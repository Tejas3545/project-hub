        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="max-w-4xl mx-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="glass-card p-6">
                        <h2 className="text-xl font-display font-bold text-text-primary mb-6">Project Details</h2>
                        <div className="space-y-6">
                            <div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <label htmlFor="isPublished" className="text-sm text-text-primary cursor-pointer">Published</label>
                            </div>
                        </div>
                    </div>

                    <div className="flex gap-4">
                        <button type="submit" disabled={loading} className="flex-1 py-3 px-4 bg-gradient-to-r from-primary to-primary-light text-white font-semibold rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50">
                            {loading ? 'Saving...' : 'Save Changes'}
                        </button>
                        <Link href="/admin/projects" className="px-6 py-3 border border-dark-lighter rounded-lg text-text-secondary hover:text-text-primary hover:border-primary/50 transition-colors text-center">
                            Cancel
                        </Link>
                    </div>
                </form>

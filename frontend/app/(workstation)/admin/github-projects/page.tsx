...
function ReviewModal({ project, status, onClose, onSubmit }: ReviewModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-[#020817]/40 backdrop-blur-sm animate-in fade-in duration-200">
      <div className="w-full max-w-lg bg-background rounded-3xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-200 border border-border">
        <div className="p-8">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              className="w-full h-40 bg-background border border-border rounded-2xl p-4 text-sm text-foreground placeholder:text-muted-foreground/60 focus:outline-none focus:border-primary focus:ring-4 focus:ring-primary/5 transition-all resize-none leading-relaxed"
            />
          </div>
    ...
    <div className="min-h-screen p-8 bg-background">
      <div className="max-w-7xl mx-auto">
            ...
            <AnimatePresence mode="popLayout">
              {projects.map((project, i) => (
                <motion.div
                  ...
                  className="bg-background rounded-[40px] border border-border shadow-sm p-1 hover:shadow-2xl hover:shadow-primary/5 hover:border-primary/20 transition-all duration-500 group relative"
                >
                  ...
                  <div className="p-10 lg:p-14 flex flex-col lg:flex-row gap-12 items-start">
                    ...
                    <div className="flex flex-row lg:flex-col gap-4 shrink-0 w-full lg:w-56 mt-2">
                      ...
                      <button
                        ...
                        className="flex-1 lg:w-full py-5 bg-background text-amber-600 border border-amber-500/30 rounded-[22px] hover:bg-amber-500/10 hover:-translate-y-1 active:scale-95 transition-all text-[11px] font-black uppercase tracking-[0.2em]"
                      >
                        Issue Rework
                      </button>
                      <button
                        onClick={() => setReviewTarget({ project, status: 'REJECTED' })}
                        className="flex-1 lg:w-full py-5 bg-background text-red-500 border border-red-500/30 rounded-[22px] hover:bg-red-500/10 hover:-translate-y-1 active:scale-95 transition-all text-[11px] font-black uppercase tracking-[0.2em]"
                      >
                        Reject Entry
                      </button>
                    </div>
        ...
        {!loading && projects.length === 0 && (
          <div className="text-center py-40 bg-background rounded-[40px] border border-dashed border-border flex flex-col items-center justify-center">

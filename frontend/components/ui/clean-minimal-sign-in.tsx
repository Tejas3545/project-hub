...
const CleanAuthForm = ({ mode = "signin" }: CleanAuthFormProps) => {
    ...
    const title = isSignIn ? "Sign in with email" : "Create an account";
    const subtitle = isSignIn
        ? "Welcome back to Project Hub. Let's get building."
        : "Join the community building real-world projects.";
    const buttonText = isSignIn ? "Sign In" : "Get Started";
    ...
    const handleSubmit = async () => {
        ...
        try {
            if (isSignIn) {
                ...
                // Login function in AuthContext usually handles redirect or state update
                // But we can force redirect just in case or rely on the context

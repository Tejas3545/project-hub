    ...
    <div className="space-y-4">
      ...
      {isCreating && (
        <Card className="p-4 border-2 border-blue-300 dark:border-blue-700">
          <input
            ...
            className="w-full mb-3 p-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
          />
          <textarea
      ...
      <div className="grid gap-4 md:grid-cols-2">
        {notes.map(note => (
          <Card
            key={note.id}
            className={`p-4 ${note.isPinned ? 'border-2 border-yellow-400 dark:border-yellow-600 bg-yellow-50 dark:bg-yellow-900/20' : ''}`}
          >
            {editingId === note.id ? (
              <div>
                <input
                  ...
                  className="w-full mb-2 p-2 border rounded-lg bg-white dark:bg-gray-800"
                />
                <textarea
                  value={note.content}
                  ...
                  className="w-full p-2 border rounded-lg bg-white dark:bg-gray-800 resize-none"
                />
              ...
              <div>
                <div className="flex items-start justify-between mb-2">
                  ...
                  <div className="flex gap-1">
                    ...
                    >
                      <Edit2 className="w-4 h-4 text-terracotta-DEFAULT" />
                    </button>
                    <button
